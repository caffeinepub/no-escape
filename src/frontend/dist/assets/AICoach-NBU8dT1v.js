import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, r as reactExports, A as AnimatePresence, m as motion } from "./index-CB4bI8Pq.js";
/**
...
function getSmartResponse(text, mode, history) {
...
function AICoach() {
  const [mode, setMode] = reactExports.useState("coach");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      id: "ai-coach-section",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-4 border-b border-border flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-warning/20 border border-warning/40 flex items-center justify-center", children: isFuture ? /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4 text-warning" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-warning" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-base uppercase tracking-widest text-foreground", children: isFuture ? "Future You" : "AI Coach" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: isFuture ? "Honest perspective from who you become" : "Helpful, direct, always in your corner" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex rounded overflow-hidden border border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `px-3 py-1.5 text-xs font-bold uppercase tracking-wider transition-colors border-r border-border ${!isFuture ? "bg-warning/20 text-warning" : "bg-secondary text-muted-foreground hover:text-foreground"}`,
                "data-ocid": "coach.tab",
                children: "COACH"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `px-3 py-1.5 text-xs font-bold uppercase tracking-wider transition-colors ${isFuture ? "bg-warning/20 text-warning" : "bg-secondary text-muted-foreground hover:text-foreground"}`,
                "data-ocid": "coach.tab",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              messages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-semibold mb-1", children: isFuture ? "Your future self is listening." : "What's on your mind?" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: isFuture ? "Ask anything — get an honest answer from who you become." : "I'll help you cut through the noise and move forward." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center", children: STARTERS[mode].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => send(s),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    msg.role === "ai" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-warning/20 border border-warning/30 flex items-center justify-center flex-shrink-0 mt-0.5", children: isFuture ? /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-3 h-3 text-warning" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3 text-warning" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `max-w-[80%] px-3 py-2.5 rounded-lg text-sm leading-relaxed ${msg.role === "user" ? "bg-pressure/20 border border-pressure/30 text-foreground" : "bg-secondary border border-border text-foreground"}`,
                        children: msg.text
                      }
                    )
                  ]
              ...
              isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-warning/20 border border-warning/30 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3 text-warning" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary border border-border px-3 py-2 rounded-lg flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3 h-3 text-warning animate-spin" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: isFuture ? "Reflecting..." : "Thinking..." })
                    ] })
                  ]
                }
              ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 border-t border-border p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                ...
                placeholder: isFuture ? "Ask your future self anything..." : "What's on your mind? I'm here to help.",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUp, { className: "w-4 h-4" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground mt-1.5 pl-0.5", children: "Enter to send • Shift+Enter for new line" })
        ] })
      ]
    }
  );
